                            ...
                            <form method="post" >
                                ...
                                <fieldset>
                                    ...
                                    <p>
                                        ...
                                        <input class="col-md-4" type="text" id="accommodates" disabled name="accommodates" value="{{$room->accommodates}}">
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <input class="col-md-4" type="text" id="price" disabled name="price" value="${{$room->price}}">
                                    </p>
                                ...
                                <a class="btn btn-primary" href="{{ route('book_room', [$room->room_id]) }}">Book Now</a>
